/* allinone合并了多个文件,下载使用多个allinone代码,可能会遇到重复的类型定义,http://zsharedcode.googlecode.com/svn/trunk/zsharedcode/panzer/.class/web/EMail.cs */
using System;
using System.Net;
...
// ../.class/web/EMail.cs
/*
 * wiki: http://code.google.com/p/zsharedcode/wiki/EMail
 * 参考文档: http://blog.sina.com.cn/s/blog_604c436d0100o08x.html (目前已经停止更新同步)
 ...
 * 测试文件:
 * http://zsharedcode.googlecode.com/svn/trunk/zsharedcode/panzer/test/TestEMail.cs
 * 合并下载:
 * http://zsharedcode.googlecode.com/svn/trunk/zsharedcode/panzer/.code/EMail.all.cs
 * 打包下载:
 * http://zsharedcode.googlecode.com/files/EMail.zip (目前已经停止更新同步)
 * http://zsharedcode.googlecode.com/files/EMail.with.test.zip (包含测试) (目前已经停止更新同步)
